...
// Desktop 
 "Desktop": [
  ...
  // ── Entrance Product ────────────────────────
  "Entrance Product": {
    "Residential Boom Barrier": ["SY-PB2500 6 Mtr", "SY-RB3000 6MTR","other"],
    "Parking Boom Barrier": ["SY-PB800","other"],
    "High Speed Toll  Barrier": ["SY-HB600", "SY-HB900","other"],
    "Toll Barrier": ["SY-TB900", "SY-TB600","other"],
    "Loop Detector": ["SY-LD01","other"],
    "Safety Sensor": ["SY-PC01","other"],
    "Single Lane  Radar": ["SY-RADAR","other"],
    "UHF Reader": ["SY-U9006001", "SY-U9006001-RJ", "SY-U15001200", "SY-U15001200-RJ","SY-UHF-9DIM-LR","other"],
    "Access Controller": ["SY-AC1", "SY-AC2", "SY-AC4","other"],
    "UHF RFID TCP IP PCB-15 mtr": ["SY-U1500 1200-RJ-PCB","other"],
    "UHF RFID TCP IP PCB-6 mtr": ["SY-U60019001 RJ (PCB)","other"],
    "UHF RFID W/G PCB-15 mtr": ["SY-U1500 1200-PCB","other"],
    "UHF RFID W/G PCB-6 mtr": ["SY-U60019001  (PCB)","other"],
    "UHF ADAPTOR": ["ADAPTOR-12V-3A(UHP ADAPTOR)","other"],
  },
