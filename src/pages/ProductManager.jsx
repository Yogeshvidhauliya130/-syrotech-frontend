...
useEffect(() => {
  fetch("https://syrotech-backend.onrender.com/api/products")
    .then(r => r.json())
    .then(data => { if (data && Object.keys(data).length > 0) setProducts(data); })
    .catch(() => {});
}, []);
  ...
  const res = await fetch("https://syrotech-backend.onrender.com/api/products/seed", {
